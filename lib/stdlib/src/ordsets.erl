...
-spec is_set(Ordset :: term()) -> boolean().
...
-spec size(Ordset :: ordset(_)) -> non_neg_integer().
...
-spec to_list(Ordset :: ordset(T)) -> [T].
...
-spec from_list(List :: [T]) -> ordset(T).
...
-spec is_element(Element :: term(), Ordset :: ordset(_)) -> boolean().
...
-spec add_element(Element, Ordset1 :: ordset(Element1)) ->
                         ordset(Element1 | Element).
...
-spec del_element(Element :: term(), Ordset1 :: ordset(T)) -> ordset(T).
...
-spec union(Ordset1 :: ordset(Element1), Ordset2 :: ordset(Element2)) ->
                   ordset(Element1 | Element2).
...
-spec union(OrdsetList :: [ordset(T)]) -> ordset(T).
...
-spec intersection(Ordset1 :: ordset(_), Ordset2 :: ordset(_)) -> ordset(_).
...
-spec intersection(OrdsetList :: [ordset(_),...]) -> ordset(_).
...
-spec is_disjoint(Ordset1 :: ordset(_), Ordset2 :: ordset(_)) -> boolean().
...
-spec subtract(Ordset1 :: ordset(Element), Ordset2 :: ordset(_)) ->
                      ordset(Element).
...
-spec is_subset(Ordset1 :: ordset(_), Ordset2 :: ordset(_)) -> boolean().
...
-spec fold(Function, Acc0 :: Acc, Ordset :: ordset(Element)) -> AccOut when
...
-spec filter(Pred, Ordset1 :: ordset(Element)) -> ordset(Element) when
